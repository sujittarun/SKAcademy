...
(function () {
  ...
  var MANAGER_TABS = [
    ...
    /* Admissions sits immediately before Members because that is the
       relationship: an application becomes a member. It was missing
       entirely at first, which is how a real submission sat in the
       database visible on no screen. */
    ["admissions.html", "Admissions", '<path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0 5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zm5 11H7v-1.2c0-1.7 3.3-2.5 5-2.5s5 .8 5 2.5V19z"/>'],
